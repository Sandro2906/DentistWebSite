...
const Footer = () => {
  ...
  return (
    ...
    <div className='flex-col flex w-full'>
        ...
        <div className='py-3'>
                <h1 className= ' py-3 text-white font-extrabold text-xl'>Connect with us</h1>
                    <div className='felx flex-row'>
                        <div className='w-[200px] h-[100px] flex'>
                            <img src={Insta} alt='SM' className='w-[50px] h-[50px] object-cover'/>
                            <img src={Fb} alt='SM' className='w-[50px] h-[50px] mx-4 object-cover'/>
                            <img src={YT} alt='SM' className='w-[70px] h-[50px] object-cover'/>
                        </div>
                    </div>
        </div>
    </div>
...
<div className='pb-6'>
<h1 className='text-white text-2xl font-extrabold'>Important links</h1>
</div>
    {
    ...
    <div className='w-full h-auto flex flex-col'>
        ...
        <div className='pb-10'>
        <h1 className='text-white text-xl'>Sign up here to hear about news, specials and daily higenic tips.</h1>
        </div>
        <div className='pb-4'>
