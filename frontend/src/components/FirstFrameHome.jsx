...
const FirstFrameHome = () => {
  ...
  return (
    <div className='w-full h-auto py-14 flex justify-around lg:flex-row flex-col'>
        ...
        <h1 className='lg:text-5xl md:text-4xl text-3xl font-bold py-3'>General & Comsetics Dentistry</h1>
        <h1 className='text-gray-300 text-xl pb-6'>Keep you smile bright!</h1>
        <button className='w-[200px] h-auto p-4 bg-blue-800 text-white rounded-md'>Book an Appointment</button>
        </div>
