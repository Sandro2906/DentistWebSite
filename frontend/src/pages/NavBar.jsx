...
const NavBar = () => {
  ...
  return (
    <div className='w-full z-20 h-20 flex justify-between items-center px-7 md:px-10 lg:px-20'>
        ...
        <h1 className='font-light text-xl'><a className='font-bold'>Cbar</a>Dentisry</h1>
    </div>
        ...
        {data.map(({id,name,link})=>(
            ...
            <h1 key={id} className='lg:text-xl md:text-sm font-semibold text-blue-900'>{name}</h1>
            </div>
            </Link>
        ))} 
        </div>
        ...
        <div className='w-[400px] hidden h-16 justify-center items-center bg-blue-300 font-semibold text-xl text-blue-700 lg:flex'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            {nav && (
                    ...
                    <div className='w-[200px] h-20 realtive flex justify-center items-center  bg-blue-300 font-semibold text-xl text-blue-700 '><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
             <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
             </svg>
             <h1>(561) 318-8762</h1>
            </div>
